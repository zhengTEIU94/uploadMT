...
fileName = str(YMD)+"_" +str(time) + ".mid"
savePath = 'Midi/OutPutMidi/' + fileName
...
parser.add_argument('--save_path', default=savePath, type=str)
parser.add_argument('--prior_midi', default='MusicTransformer-tensorflow2.0/Midi/MidiSource/BENABD10.mid', type=str, help='prior data for generate midi file')
